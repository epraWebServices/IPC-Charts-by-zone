...
import NetworkSimulationCharts from '../MarketSimulation/MarketSimulationCharts'
import { useHistory } from 'react-router-dom';
import NetworkMap from './NetworkMap_V8';
import { Dialog } from 'primereact/dialog';
import "./DialogCss.css"
const NetworkSimulation3 = (props) => {
              ...
              <h4>Network Simulation</h4>
                <div className='grid'>
                  <div className="col-4">
                      <div className="p-fluid">
                          ...
                          {(fleet.code === 'false') && <div> 
                            <Dialog resizable={false} header={header} visible={visible} style={{width:"100%",height:"100%"}} modal onHide={HideDialog}><NetworkMap base_year={base_year}></NetworkMap></Dialog>
                            </div>}      
                            {(fleet.code === 'false') && <div> 
                  ...
                  <div className="col-0">
                    ...
                    <div className="col-7">
                        {IsSelectBaseYear &&<NetworkSimulationCharts label={label} color={color} generation_fleet_data2 = {generation_fleet_data2} dataForLine={dataForLine} annual_demand={annual_demand} peak_load={peak_load}/>}
                    </div>
                </div>
...
export default NetworkSimulation3;