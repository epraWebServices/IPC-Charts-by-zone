...
import NetworkMap from './NetworkMap_V5';
                  ...
                  <div className="col-4">
                      <div className="p-fluid">
                          ...
                          {(fleet.code === 'false') && <div> 
                            <Dialog header="Network Map" visible={visible} style={{width:"100%",height:"100%"}} modal onHide={HideDialog}><NetworkMap></NetworkMap></Dialog>
                            </div>}      
                            {(fleet.code === 'false') && <div> 
