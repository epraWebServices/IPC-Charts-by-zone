        ...
        const fleet_value_handler = (event, i) => {
          ...
          return (
            ...
            <thead><tr>
              ...
              <th style={{fontSize:"18px"}}>Fleet <br></br> in Base Year (GW)</th>
              <th style={{width:'122px',fontSize:"18px"}}>Customized <br></br>Fleet (GW)</th>
            </tr></thead>

            <tr><th></th>
              <td style={{backgroundColor:"#FBE5D6", width:'150px', border:"none"}}>Natural Gas:</td>
              <td style={{backgroundColor:"#FBE5D6", width:'160px', textAlign:"center", border:"none"}}>{generation_fleet_data.datasets[0].data[0]}</td>
              <td style={{border:"none"}}>
                ...
                <input id ="Natural_Gas" type="text" data-step="1" data-min="0" defaultValue={fleet_values[0].value} onChange={(e) => fleet_value_handler(e, 0)} style={{width:'60px', textAlign:"center", height:'30px', fontSize:"16px", border:"0", outline:"0"}}/>
            ...
            <tr><th></th>
              ...
              <td style={{backgroundColor:"#9CD7FF", width:'160px', textAlign:"center", border:"none"}}>{generation_fleet_data.datasets[0].data[1]}</td>
              <td style={{border:"none"}}>
                ...
                <input id ="Hydro_Dam" type="text" data-step="1" data-min="0" defaultValue={fleet_values[1].value} onChange={(e) => fleet_value_handler(e, 1)} style={{width:'60px', textAlign:"center", height:'30px', fontSize:"16px", border:"0", outline:"0"}}/>
            ...
            <tr><th></th>
              ...
              <td style={{backgroundColor:"#EDEDED", width:'160px', textAlign:"center", border:"none"}}>{generation_fleet_data.datasets[0].data[10]}</td>
              <td style={{border:"none"}}>
                ...
                <input id ="Local" type="text" data-step="1" data-min="0" defaultValue={fleet_values[3].value} onChange={(e) => fleet_value_handler(e, 3)} style={{width:'60px', textAlign:"center", height:'30px', fontSize:"16px", border:"0", outline:"0"}}/>
            ...
            <tr><th></th>
              ...
              <td style={{backgroundColor:"#EDEDED", width:'160px', textAlign:"center", border:"none"}}>{generation_fleet_data.datasets[0].data[3]}</td>
              <td style={{border:"none"}}>
                ...
                <input id ="Imported" type="text" data-step="1" data-min="0" defaultValue={fleet_values[4].value} onChange={(e) => fleet_value_handler(e, 4)} style={{width:'60px', textAlign:"center", height:'30px', fontSize:"16px", border:"0", outline:"0"}}/>
            ...
            <tr><th></th>
              ...
              <td style={{backgroundColor:"#EDEDED", width:'160px', textAlign:"center", border:"none"}}>{generation_fleet_data.datasets[0].data[2]}</td>
              <td style={{border:"none"}}>
                ...
                <input id ="Lignite" type="text" data-step="1" data-min="0" defaultValue={fleet_values[5].value} onChange={(e) => fleet_value_handler(e, 5)} style={{width:'60px', textAlign:"center", height:'30px', fontSize:"16px", border:"0", outline:"0"}}/>
            ...
            <tr><th></th>
              ...
              <td style={{backgroundColor:"#E2F0D9", width:'160px', textAlign:"center", border:"none"}}>{generation_fleet_data.datasets[0].data[6]}</td>
              <td style={{border:"none"}}>
                ...
                <input id ="Solar" type="text" data-step="1" data-min="0" defaultValue={fleet_values[6].value} onChange={(e) => fleet_value_handler(e, 6)} style={{width:'60px', textAlign:"center", height:'30px', fontSize:"16px", border:"0", outline:"0"}}/>
            ...
            <tr><th></th>
              ...
              <td style={{backgroundColor:"#E2F0D9", width:'160px', textAlign:"center", border:"none"}}>{generation_fleet_data.datasets[0].data[4]}</td>
              <td style={{border:"none"}}>
                ...
                <input id ="Onshore" type="text" data-step="1" data-min="0" defaultValue={fleet_values[7].value} onChange={(e) => fleet_value_handler(e, 7)} style={{width:'60px', textAlign:"center", height:'30px', fontSize:"16px", border:"0", outline:"0"}}/>
                  ...
                  <div className="col-4">
                      <div className="p-fluid">
                          <div className="field" style={{paddingBottom:"5px"}}>
                              <label htmlFor="name1" style={{fontSize:"18px"}}>Base Year Selection <img src="./info_V1.png" title="Info if necessary"/></label>
                          ...
                          {IsSelectBaseYear && <div className="field" style={{paddingBottom:"5px"}}>
                            <label htmlFor="name1" style={{fontSize:"18px"}}>Analysis Type <img src="./info_V1.png" title="Info if necessary"/></label>
                          ...
                          {IsSelectBaseYear && <div className="field" style={{paddingBottom:"5px"}}>
                              <label htmlFor="name1" style={{fontSize:"18px"}}>MCP Estimation <img src="./info_V1.png" title="Info if necessary"/></label>
                          ...
                          {IsSelectBaseYear && <div className="field" style={{paddingBottom:"10px"}}>
                              <label htmlFor="name1" style={{fontSize:"18px"}}>Fleet Selection <img src="./info_V1.png" title="Info if necessary"/></label>
