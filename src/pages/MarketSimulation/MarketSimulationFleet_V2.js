...
const MarketSimulationFleet = (props) => {
    ...
    if(Object.values(sliders).every(isZero) && demandFactor == 100 ){
      isDisabled = true      
    }
    else{
      isDisabled = false
    ...
    function reset(){
      ...
      return (
        ...
        <tr><th></th>
          <td style={{backgroundColor:"#FBE5D6", border:"1px solid rgba(0, 0, 0,0.2)"}}>Natural Gas:</td>
          <td style={{backgroundColor:"#FBE5D6", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.natural_gas}</td>
          ...
          <td>
          <Inp id="gas" style={{backgroundColor:"#FBE5D6",border:"1px solid rgba(0, 0, 0,0.2)", width:"100%"}} min={0} max={30+gen_fleet.natural_gas} value={Math.round((gen_fleet.natural_gas + sliders[0])*1000)/1000} onChange={(e) => setSliders(sliders =>({...sliders,[0]:e-gen_fleet.natural_gas}))} />
          </td>
          
        </tr>

        <tr><th></th>
          <td style={{backgroundColor:"#9CD7FF", border:"1px solid rgba(0, 0, 0,0.2)"}}>Hydro (Dam):</td>
          <td style={{backgroundColor:"#9CD7FF", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.hydro_dam}</td>
          <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
          ...
          <td>
          <Inp id="dam" style={{backgroundColor:"#9CD7FF", border:"1px solid rgba(0, 0, 0,0.2)", width:"100%"}} min={0} max={30+gen_fleet.hydro_dam} value={Math.round((gen_fleet.hydro_dam + sliders[1])*1000)/1000} onChange={(e) => setSliders(sliders =>({...sliders,[1]:e-gen_fleet.hydro_dam}))} />
          </td>

        </tr>

        <tr><th></th>
            <td style={{backgroundColor:"#9CD7FF", border:"1px solid rgba(0, 0, 0,0.2)"}}>Hydro (RoR):</td>
            <td style={{backgroundColor:"#9CD7FF", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.hydro_ror}</td>
            <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
            </td>
            <td>
            <Inp id="ror"  disabled style={{backgroundColor:"#9CD7FF",border:"1px solid rgba(0, 0, 0,0.2)", width:"100%", color:"black"}} min={0} max={30+gen_fleet.hydro_ror} value={Math.round((gen_fleet.hydro_ror )*1000)/1000}  />
            </td>
          
        </tr>
        
        <tr><th></th>
          <td style={{backgroundColor:"#EDEDED", border:"1px solid rgba(0, 0, 0,0.2)"}}>Local Coal:</td>
          <td style={{backgroundColor:"#EDEDED", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.local_coal}</td>
          <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
          ...
          <td>
          <Inp id="local" style={{backgroundColor:"#EDEDED", border:" 1px solid rgba(0, 0, 0,0.2) " ,width:"100%"}} min={0} max={30+gen_fleet.local_coal} value={Math.round((gen_fleet.local_coal + sliders[2])*1000)/1000} onChange={(e) => setSliders(sliders =>({...sliders,[2]:e-gen_fleet.local_coal}))} />
          </td>
        </tr>

        <tr><th></th>
          <td style={{backgroundColor:"#EDEDED", border:"1px solid rgba(0, 0, 0,0.2)"}}>Imported Coal:</td>
          <td style={{backgroundColor:"#EDEDED", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.imported_coal}</td>
          <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
          ...
          <td>
          <Inp id="import" style={{backgroundColor:"#EDEDED",border:"1px solid rgba(0, 0, 0,0.2)", width:"100%"}} min={0} max={30+gen_fleet.imported_coal} value={Math.round((gen_fleet.imported_coal + sliders[3])*1000)/1000} onChange={(e) => setSliders(sliders =>({...sliders,[3]:e-gen_fleet.imported_coal}))} />
          </td>
          
        </tr>

        <tr><th></th>
          <td style={{backgroundColor:"#EDEDED", border:"1px solid rgba(0, 0, 0,0.2)"}}>Lignite:</td>
          <td style={{backgroundColor:"#EDEDED", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.lignite}</td>
          <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
          ...
          <td>
          <Inp id="lignite" style={{backgroundColor:"#EDEDED",border:"1px solid rgba(0, 0, 0,0.2)" ,  width:"100%"}} min={0} max={30+gen_fleet.lignite} value={Math.round((gen_fleet.lignite + sliders[4])*1000)/1000} onChange={(e) => setSliders(sliders =>({...sliders,[4]:e-gen_fleet.lignite}))} />
          </td>
          
        </tr>

        <tr><th></th>
          <td style={{backgroundColor:"#E2F0D9", border:"1px solid rgba(0, 0, 0,0.2)"}}>Solar:</td>
          <td style={{backgroundColor:"#E2F0D9", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.solar_pv}</td>
          <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
          ...
          <td>
          <Inp id= "solar" style={{backgroundColor:"#E2F0D9",border:"1px solid rgba(0, 0, 0,0.2)", width:"100%"}} min={0} max={50} value={Math.round((gen_fleet.solar_pv + sliders[5])*1000)/1000} onChange={(e) => setSliders(sliders =>({...sliders,[5]:e-gen_fleet.solar_pv}))} />
          </td>
          
        </tr>

        <tr><th></th>
          <td style={{backgroundColor:"#E2F0D9", border:"1px solid rgba(0, 0, 0,0.2)"}}>Wind:</td>
          <td style={{backgroundColor:"#E2F0D9", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.wind_onshore}</td>
          <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
          ...
          <td>
          <Inp id="wind" style={{backgroundColor:"#E2F0D9",border:"1px solid rgba(0, 0, 0,0.2)", width:"100%"}} min={0} max={50} value={Math.round((gen_fleet.wind_onshore + sliders[6])*1000)/1000} onChange={(e) => setSliders(sliders =>({...sliders,[6]:e-gen_fleet.wind_onshore}))} />
          </td>
        </tr>
        
        <tr><th></th>
          <td style={{backgroundColor:"#EFBBBB", border:"1px solid rgba(0, 0, 0,0.2)"}}>Nuclear:</td>
          <td style={{backgroundColor:"#EFBBBB", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.nuclear}</td>
          <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
          ...
          <td>
          <Inp id="nuclear" disabled style={{backgroundColor:"#EFBBBB",border:"1px solid rgba(0, 0, 0,0.2)", width:"100%", color:"black"}} min={0} max={7.2} step={1.2} value={Math.round((gen_fleet.nuclear + sliders[7])*1000)/1000} onChange={(e) => setSliders(sliders =>({...sliders,[7]:e-gen_fleet.nuclear}))} />
          </td>

        </tr>
        <tr><th></th>
          <td style={{backgroundColor:"#EFBBBB", border:"1px solid rgba(0, 0, 0,0.2)"}}>Biomass:</td>
          <td style={{backgroundColor:"#EFBBBB", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.biomass}</td>
          <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
          </td>
          <td>
          <Inp id="biomass" disabled style={{backgroundColor:"#EFBBBB",border:"1px solid rgba(0, 0, 0,0.2)", width:"100%", color:"black"}} min={0} max={7.2} step={1.2} value={Math.round((gen_fleet.biomass )*1000)/1000}  />
          </td>

        </tr>
        <tr><th></th>
          <td style={{backgroundColor:"#EFBBBB", border:"1px solid rgba(0, 0, 0,0.2)"}}>Geothermal:</td>
          <td style={{backgroundColor:"#EFBBBB", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.geothermal}</td>
          <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
          </td>
          <td>
          <Inp id="geothermal" disabled style={{backgroundColor:"#EFBBBB",border:"1px solid rgba(0, 0, 0,0.2)", width:"100%", color:"black"}} min={0} max={7.2} step={1.2} value={Math.round((gen_fleet.geothermal)*1000)/1000}  />
          </td>

          </tr>
        <tr><th></th>
          <td style={{backgroundColor:"#EFBBBB", border:"1px solid rgba(0, 0, 0,0.2)"}}>Other:</td>
          <td style={{backgroundColor:"#EFBBBB", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.other}</td>
          <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
          </td>
          <td>
          <Inp id="other" disabled style={{backgroundColor:"#EFBBBB", width:"100%",border:"1px solid rgba(0, 0, 0,0.2)", color:"black"}} min={0} max={7.2} step={1.2} value={Math.round((gen_fleet.other )*1000)/1000}  />
          </td>
        ...
        <tr><th></th>
          <td style={{backgroundColor:"#7FCBC4", border:"1px solid rgba(0, 0, 0,0.2)"}}>ENTSO-E:</td>
          <td style={{backgroundColor:"#7FCBC4", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.entsoe}</td>
          <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
          ...
          <td>
          <Inp id="entsoe" style={{backgroundColor:"#7FCBC4",border:"1px solid rgba(0, 0, 0,0.2)", width:"100%"}} min={0} max={2.2} step={0.1} value={Math.round((gen_fleet.entsoe + sliders[8])*1000)/1000} onChange={(e) => setSliders(sliders =>({...sliders,[8]:e-gen_fleet.entsoe}))} />
          </td>
          
        </tr>
        <tr><th></th>
          <td style={{backgroundColor:"#7FCBC4", border:"1px solid rgba(0, 0, 0,0.2)"}}>Georgia:</td>
          <td style={{backgroundColor:"#7FCBC4", textAlign:"center", border:"1px solid rgba(0, 0, 0,0.2)"}}>{gen_fleet.georgia}</td>
          <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
          ...
          <td>
          <Inp id="georgia" style={{backgroundColor:"#7FCBC4", border:" 1px solid rgba(0, 0, 0,0.2)" , width:"100%"}} min={0} max={2} step={0.1} value={Math.round((gen_fleet.georgia + sliders[9])*1000)/1000} onChange={(e) => setSliders(sliders =>({...sliders,[9]:e-gen_fleet.georgia}))} />
          </td>

          </tr>
          <tr><th></th>
          <td style={{backgroundColor:"#616161", border:"1px solid rgba(0, 0, 0,0.2)" , fontWeight:'bold', color:'#ffffff',fontSize:'18px'}}>Total:</td>
          <td style={{backgroundColor:"#616161",textAlign:"center",fontWeight:'bold', border:"1px solid rgba(0, 0, 0,0.2)", color:'#ffffff',fontSize:'18px'}}>{gen_fleet.natural_gas + gen_fleet.hydro_dam + gen_fleet.local_coal + gen_fleet.imported_coal + gen_fleet.lignite + gen_fleet.solar_pv + gen_fleet.wind_onshore + gen_fleet.nuclear + gen_fleet.entsoe + gen_fleet.georgia}</td>
          <td style={{border:"1px solid rgba(0, 0, 0,0.2)"}}>
          </td>
          <td>
          <Inp id= "total"  disabled style={{backgroundColor:"#616161",border:"1px solid rgba(0, 0, 0,0.2)", width:"100%", color:"#ffffff",fontWeight:'bold',fontSize:'18px'}}  value={Math.round((gen_fleet.natural_gas + gen_fleet.hydro_dam + gen_fleet.local_coal + gen_fleet.imported_coal + gen_fleet.lignite + gen_fleet.solar_pv + gen_fleet.wind_onshore + gen_fleet.nuclear + gen_fleet.entsoe + gen_fleet.georgia + sliders[0] + sliders[1]+ sliders[2]+sliders[3] + sliders [4]+sliders[5]+sliders[6]+ sliders[7] + sliders[8]+sliders[9])*1000)/1000} />
          </td>
        ...
        <br></br><br></br>
        <Row>
          <Col span={16}>Demand Factor: <InputNumber id = "demand" inputId="horizontal" value={demandFactor} min={50} max={150} onValueChange={(e) => setDemandFactor(e.value)} showButtons buttonLayout="horizontal" decrementButtonClassName="p-button-danger" incrementButtonClassName="p-button-success" incrementButtonIcon="pi pi-plus" decrementButtonIcon="pi pi-minus" prefix="%" style={{width:"40%", height:"40px"}}/>
        &emsp; {(annual_demand * demandFactor / 100).toFixed(2)} TWh</Col>
          <Col span={3}><div style={{textAlign:"center"}}><Divider layout="vertical"></Divider></div></Col>

              <Col span={5}><div style={{textAlign:"right"}}><Button label="Reset" raised  disabled={isDisabled} style = {{width:'120px',height:'45px',textAlign:"center",fontSize:"18px"}} onClick = {reset}></Button></div></Col>
