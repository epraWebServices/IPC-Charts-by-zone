...
const MarketSimulationFleet = (props) => {
    ...
    function checkMatchedTemplate(sliders){
      if (base_year.code === "2030" || base_year.code === "2032"){
        if(demandFactor === 100 && sliders[0] === 0 && sliders[2]=== 0 && sliders[3]=== 0 && sliders[4]=== 0 && sliders[7]=== 0 && sliders[8]=== 0 && sliders[9]=== 0 && (sliders[5]>= 5 || sliders[6]>= 5)){
          ...
          }else if((demandFactor === 100 && sliders[0] <= -3 || sliders[2] <= -0.5 || sliders[3] <= -5 || sliders[4] <= -5) && sliders[5]=== 0 && sliders[6]=== 0 && sliders[7]=== 0 && sliders[8]=== 0 && sliders[9]=== 0){
          ...
          }else if(demandFactor<=85 && demandFactor>=70 && sliders[0]=== 0 && sliders[2]=== 0 && sliders[3]=== 0 && sliders[4]=== 0 && sliders[5]=== 0 && sliders[6]=== 0 && sliders[7]=== 0 && sliders[8]=== 0 && sliders[9]=== 0){
