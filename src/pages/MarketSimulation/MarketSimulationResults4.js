    ...
    <Panel style={{fontSize:"20px"}}>
       ...
       <Accordion>
          <AccordionTab header={headertext} style={{fontSize:"20px"}}>
              ...
              <p align ="center " style={{fontSize:"20px"}}>Year: {baseYear}</p>
              <TableContainer component={Paper}>
                <Table sx={{ minWidth: 650 , fontWeight:'bold' }} aria-label="simple table">
                  <TableHead>
                    <TableRow sx = {{backgroundColor: "#DBDCDB"}}>
                      <TableCell style={{fontSize:"18px"}} > </TableCell>
                      <TableCell align="center" style={{fontSize:"18px"}} >{fleet[0].label}</TableCell>
                      <TableCell align="center" style={{fontSize:"18px"}} >{fleet[1].label}</TableCell>
                      <TableCell align="center" style={{fontSize:"18px"}} >{fleet[2].label}</TableCell>
                      <TableCell align="center" style={{fontSize:"18px"}} >{fleet[3].label}</TableCell>
                      <TableCell align="center" style={{fontSize:"18px"}} >{fleet[4].label}</TableCell>
                      <TableCell align="center" style={{fontSize:"18px"}} >{fleet[5].label}</TableCell>
                      <TableCell align="center" style={{fontSize:"18px"}} >{fleet[6].label}</TableCell>
                      <TableCell align="center" style={{fontSize:"18px"}} >{fleet[7].label}</TableCell>
                      <TableCell align="center" style={{fontSize:"18px"}} >{fleet[8].label}</TableCell>
                      <TableCell align="center" style={{fontSize:"18px"}} >{fleet[9].label}</TableCell>
                      <TableCell align="center" style={{fontSize:"18px"}} >{fleet[10].label}</TableCell>
                      <TableCell align="center" style={{fontSize:"18px"}} >{fleet[11].label}</TableCell>
                      <TableCell align="center" style={{fontSize:"18px"}} >{fleet[12].label}</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    <TableRow sx = {{backgroundColor: "#ECECEC"}}>
                        <TableCell style={{fontSize:"18px"}} > Fleet (MW) </TableCell>
                        <TableCell align="center" style={{fontSize:"18px"}} > {fleet[0].value}</TableCell>
                        <TableCell align="center" style={{fontSize:"18px"}} >{fleet[1].value}</TableCell>
                        <TableCell align="center" style={{fontSize:"18px"}} >{fleet[2].value}</TableCell>
                        <TableCell align="center" style={{fontSize:"18px"}} >{fleet[3].value}</TableCell>
                        <TableCell align="center" style={{fontSize:"18px"}} >{fleet[4].value}</TableCell>
                        <TableCell align="center" style={{fontSize:"18px"}} >{fleet[5].value}</TableCell>
                        <TableCell align="center" style={{fontSize:"18px"}} >{fleet[6].value}</TableCell>
                        <TableCell align="center" style={{fontSize:"18px"}} >{fleet[7].value}</TableCell>
                        <TableCell align="center" style={{fontSize:"18px"}} >{fleet[8].value}</TableCell>
                        <TableCell align="center" style={{fontSize:"18px"}} >{fleet[9].value}</TableCell>
                        <TableCell align="center" style={{fontSize:"18px"}} >{fleet[10].value}</TableCell>
                        <TableCell align="center" style={{fontSize:"18px"}} >{fleet[11].value}</TableCell>
                        <TableCell align="center" style={{fontSize:"18px"}} >{fleet[12].value}</TableCell>
                      </TableRow>
                  </TableBody>
                </Table>
              </TableContainer>
      ...
      <div className="grid" style={{paddingTop:"1rem"}}>
        ...
        <div>
          <DivAntd type="vertical" style={{height:"600px", backgroundColor:"#BDBDBD"}}/>
        </div>
        <div style={{width:"48%", height:"450"}}>
        <div style={{textAlign:"center", fontFamily: 'Arial' , fontWeight:'bold', fontSize:'18px', color:'#5f5f5f'}}>Share of Each Generation Technology in Supplying the Total Demand</div>
          
          <ResponsivePie
            
            height='600'
            data= {data_gen}
            margin={{ top: 40, right: 140, bottom: 30, left: 140 }}
      ...
      {(process_type === "MS_Optimization_MCP_Estimation" || process_type === "MS_ML_Based_MCP_Estimation") &&
        ...
        <div className="grid">
          ...
          <div style={{textAlign:"center", fontFamily: 'Arial' , fontWeight:'bold', fontSize:'18px', color:'#5f5f5f'}}>Market Clearing Price-Seasonal Estimation</div>
        ...
        <div style={{width:"48%", height:"400px"}}>
        <div style={{textAlign:"center", fontFamily: 'Arial' , fontWeight:'bold', fontSize:'18px', color:'#5f5f5f'}}>Market Clearing Price - Monthly Estimation</div>
            <div style={{width:"75%", height:"500px", float:"left"}}>
              <Bar
                width="100%"
                height="500"
